...
public class ActionSupprRealisateur extends Action
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try
		{
			...
			ModifRelationFilmPers modif = new ModifRelationFilmPers(-1, auteur, new Date(), null, null, p, null, null, null, film);
			daoModif.save(modif);
